...
nsite       <- 335 # total number of sites
...
#===============
### Sites
sites_imbcr <- c(rep(1,100), rep(0,235))
sites_bbs <- c(rep(0,75), rep(1,150), rep(0,110))
sites_ebird <- c(rep(0,60), rep(1,15), rep(0,15), rep(1,10), rep(0,60), rep(1,175))
